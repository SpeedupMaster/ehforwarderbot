...
ARG EFB_WECHAT_COMWECHAT_SLAVE_REF=f3e8824e6ff2d57c74cef3443e46c62212d4d4ce
...
RUN pip3 install --no-cache-dir ehforwarderbot python-telegram-bot; \
    ...
    pip3 install --no-cache-dir git+https://github.com/SpeedupMaster/efb-wechat-comwechat-slave.git@${EFB_WECHAT_COMWECHAT_SLAVE_REF}; \
